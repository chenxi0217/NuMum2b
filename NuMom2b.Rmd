...
df3$variable[df3$variable == "v1_pregplanned2"] <- "Pregnancy"
...
ggsave(file="2-cluster prediction lasso.pdf", width=20, height=15, dpi=300)
...
df5$variable[df5$variable == "v1_pregplanned2:1"] <- "Pregnancy: cluster 1"
...
df6$variable[df6$variable == "v1_pregplanned2:2"] <- "Pregnancy: cluster 2"
